...
class Color {
  constructor(
    public grey: ColorNumber,
    public primary: ColorNumber,
    public greenAccent: ColorNumber,
    public redAccent: ColorNumber,
    public blueAccent: ColorNumber
  ) {}
}
export const tokens = (mode: string): Color => ({
  ...(mode === "dark"
    ? {
        grey: {
          100: "#e0e0e0",
...
export const themeSettings = (mode: string): object => {
  ...
  return {
    palette: {
      ...
      ...(mode === "dark"
        ? {
            praimary: { main: colors.primary[500] },
        ...
        : {
            praimary: { main: colors.primary[100] },
            secondary: { main: colors.greenAccent[500] },
            neutral: {
              dark: colors.grey[700],
              main: colors.grey[500],
